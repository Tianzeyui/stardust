...
export async function chat(
  ...
  opts?: { abortSignal?: AbortSignal; autoMode?: boolean; promptMode?: 'code' | 'chat'; localModelId?: string; forceCompression?: boolean; selectedTools?: Set<string> | null; memoryInjection?: string; userId?: string; modelOverride?: { provider: string; modelId: string } },
) {
  // 本地模型路径
  ...
  let agentRules = opts?.promptMode === 'chat' ? getPromptChat() : getPromptCode()
